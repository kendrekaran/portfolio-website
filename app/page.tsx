  ...
  return <div className="quiet-page">
    ...
    <main id="main-content">
      ...
      <section className="quiet-intro" aria-label="About me">
        ...
        <p>I’ve written and created posts for major AI companies, turning technical ideas into clear, engaging content. I also share what I learn about AI and technology on <a href="https://x.com/karaan_dev" target="_blank" rel="noopener noreferrer">X, as @karaan_dev</a>. My content has generated over 100M impressions.</p>
      ...
      <section id="experience" aria-labelledby="experience-title" className="quiet-experience">
        ...
        <details className="quiet-article"><summary>Development / Kargul Studio<span aria-hidden="true">⌄</span></summary><div className="quiet-detail"><p className="quiet-small">Jan 2026 – May 2026</p><p>Built web interfaces at <a href="https://kargul.studio" target="_blank" rel="noopener noreferrer">Kargul Studio ↗</a></p></div></details>
        ...
        <details className="quiet-article"><summary>Writing / AI & Technology<span aria-hidden="true">⌄</span></summary><div className="quiet-detail"><p className="quiet-small">2024 – Present</p><p>My content on AI and technology has generated over 100M impressions on <a href="https://x.com/karaan_dev" target="_blank" rel="noopener noreferrer">@karaan_dev ↗</a></p></div></details>
      </section>
