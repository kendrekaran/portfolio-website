  ...
  return <div className="quiet-page">
    ...
    <main id="main-content">
      ...
      <section id="experience" aria-labelledby="experience-title" className="quiet-experience">
        ...
        <details className="quiet-article"><summary>Writing / AI & Technology<span aria-hidden="true">⌄</span></summary><div className="quiet-detail"><p className="quiet-small">2024 – Present</p><p>My content on AI and technology has generated over 100M impressions on <a href="https://x.com/karankendre" target="_blank" rel="noopener noreferrer">@karankendre ↗</a></p></div></details>
      </section>
